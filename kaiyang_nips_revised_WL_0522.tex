...
%Meanwhile, the ability of APGE capturing the link and unsensitive attributes information does not decrease significantly.
%
\begin{table}
\small
...
\begin{figure}[!ht]
     \subfloat[utilty/privacy on Yale\label{Classcial AAE}]{%
       \includegraphics[width=0.48\textwidth]{yaleu_p.eps}
     }
     \hfill
     \subfloat[utilty/privacy on Rochestor\label{Supervised AAE}]{%
       \includegraphics[width=0.48\textwidth]{rochu_p.eps}
     }
...
\begin{figure}[!ht]
     \subfloat[Impact on Utility\label{subfig-1:dummy}]{%
       \includegraphics[width=0.48\textwidth]{impact1.eps}
     }
     \hfill
     \subfloat[Impact on privacy\label{subfig-2:dummy}]{%
       \includegraphics[width=0.48\textwidth]{impact2.eps}
     }
